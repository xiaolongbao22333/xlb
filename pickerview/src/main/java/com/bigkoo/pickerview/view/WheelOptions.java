...
public class WheelOptions<T> {
    ...
    private boolean threeOrFour = false;//三级或四级 默认三级
            ...
            public void onItemSelected(int index) {
                ...
                if (mOptions2Items == null) {//只有1级联动数据
                    ...
                    if (mOptions3Items != null) {
                        ...
                        if (optionsSelectChangeListener != null) {
                            optionsSelectChangeListener.onOptionsSelectChanged(index, 0, 0,0);
                        }
                    }
        ...
        wheelListener_option2 = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                if (mOptions3Items != null) {
                    ...
                    wv_option3.setAdapter(new ArrayWheelAdapter(mOptions3Items.get(wv_option1.getCurrentItem()).get(index)));
                    wv_option4.setAdapter(new ArrayWheelAdapter(mOptions4Items.get(wv_option1.getCurrentItem()).get(index).get(0)));
                    wv_option3.setCurrentItem(opt3);
                    wv_option4.setCurrentItem(0);
        ...
        wheelListener_option3 = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                if (mOptions4Items != null) {
                    ...
                    opt2Select = opt2Select >= mOptions2Items.get(opt1Select).size() - 1 ? mOptions2Items.get(opt1Select).size() - 1 : opt2Select;
                    ...
                    //3级联动数据实时回调
                    if (optionsSelectChangeListener != null) {
                        optionsSelectChangeListener.onOptionsSelectChanged(wv_option1.getCurrentItem(), opt2Select,index,opt4);
                    }
    ...
    /**
     * 返回当前选中的结果对应的位置数组 因为支持四级联动效果，分三个级别索引，0，1，2,3。
    ...
    public void setThreeOrFour(boolean threeOrFour) {
        this.threeOrFour = threeOrFour;
    }

    public boolean getThreeOrFour() {
        return threeOrFour;
    }

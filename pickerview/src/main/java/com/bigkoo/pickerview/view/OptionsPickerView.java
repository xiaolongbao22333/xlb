...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private void reSetCurrentItems() {
        if (wheelOptions != null) {
            if (wheelOptions.getThreeOrFour()){
    ...
    public void setPicker(List<T> optionsItems) {
        this.setPicker(optionsItems, null, null,null);
    }

    public void setPicker(List<T> options1Items, List<List<T>> options2Items) {
        this.setPicker(options1Items, options2Items, null,null);
    }
    ...
    public void setPicker(List<T> options1Items,
        ...
        wheelOptions.setThreeOrFour(true);
    ...
    public void returnData() {
        if (mPickerOptions.optionsSelectListener != null) {
            ...
            if (wheelOptions.getThreeOrFour()){
                mPickerOptions.optionsSelectListener.onOptionsSel(optionsCurrentItems[0], optionsCurrentItems[1], optionsCurrentItems[2],optionsCurrentItems[3], clickView);
